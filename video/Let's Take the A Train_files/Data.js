...
Panopto.Data.registerPanoptoEnum = function (name) {
    ...
    Panopto.Data[name].getDisplayName = function (value) {
        var nameByValue = Panopto.Data[name].getName(value);
        // Return localized string, defaulting to non-localized version if not found.
        var displayName = Panopto.GlobalResources[name + "_" + nameByValue] || nameByValue;
...
Panopto.Data.AclRoleType = function () {
    ...
    /// <field name="DepartmentAdmin" type="Number" />
};
...
Panopto.Data.SessionColumns = function () {
    ...
    ///     DataLib/LinqWrappers/WebUI/SessionRow/SessionsRow.cs and SessionColumns_* resources.
    /// </summary>
    ///
    ...
    /// <field name="RuleViolationDate" />
    /// <field name="RuleGroupViolated" />
};
Panopto.Data.SessionColumns.prototype =
    {
        ...
        Order: 10,
        DeletedDate: 11,
        RuleViolationDate: 12,
        RuleGroupViolated: 13
    };
...
Panopto.Data.SessionStatus.getIcon = function (status) {
    /// <summary>
    ///     Returns an object with svgUrl, cssClass and title for the given status.
    ...
    if (!Panopto.Data.SessionStatus._statusIcons) {
        ...
        Panopto.Data.SessionStatus._statusIcons[Panopto.Data.SessionStatus.Complete] = {
            svgUrl: "images/icons/ic_play_circle_filled_white_48px.svg",
            title: Panopto.GlobalResources.SessionStatus_Complete,
            cssClass: "complete"
        };
        Panopto.Data.SessionStatus._statusIcons[Panopto.Data.SessionStatus.Created] = {
            svgUrl: "images/icons/ic_panorama_fish_eye_24px.svg",
            title: Panopto.GlobalResources.SessionStatus_Created,
            cssClass: "created"
        };
        Panopto.Data.SessionStatus._statusIcons[Panopto.Data.SessionStatus.Processing] = {
            svgUrl: "images/icons/ic_autorenew_24px.svg",
            title: Panopto.GlobalResources.SessionStatus_Processing,
            cssClass: "processing"
        };
        Panopto.Data.SessionStatus._statusIcons[Panopto.Data.SessionStatus.Recording] = {
            svgUrl: "images/icons/ic_fiber_smart_record_24px.svg",
            title: Panopto.GlobalResources.SessionStatus_Recording,
            cssClass: "recording"
        };
        Panopto.Data.SessionStatus._statusIcons[Panopto.Data.SessionStatus.Scheduled] = {
            svgUrl: "images/icons/ic_schedule_24px.svg",
            title: Panopto.GlobalResources.SessionStatus_Scheduled,
            cssClass: "scheduled"
        };
        Panopto.Data.SessionStatus._statusIcons[Panopto.Data.SessionStatus.Live] = {
            svgUrl: "images/icons/ic_fiber_smart_record_24px.svg",
            title: Panopto.GlobalResources.SessionStatus_Live,
            cssClass: "live"
        };
    }
...
Panopto.Data.GroupColumns = function () {
    /// <summary>
    ///     enum Panopto.Data.GroupColumns
    /// </summary>
    ///
    /// <field name="Name" type="Number" />
    /// <field name="Owner" type="Number" />
    /// <field name="TotalMembers" type="Number" />
    /// <field name="Provider" type="Number" />
    /// <field name="ExternalID" type="Number" />
};
...
Panopto.Data.TranscriptionStatus = function () {
    ...
    /// <field name="SessionHasNoAudio" type="Number" />
    /// <field name="GeneratingMediaFiles" type="Number" />
    /// <field name="MediaFilesReady" type="Number" />
};
...
Panopto.Data.NetworkRuleColumns = function () {
    /// <summary>
    ///     enum Panopto.Data.NetworkAccesRuleColumns
    /// </summary>
    ///
    /// <field name="Name" type="String" />
    /// <field name="Default" type="String" />
    /// <field name="AllowedLocations" type="Number" />
};
Panopto.Data.NetworkRuleColumns.prototype =
    {
        Name: 0,
        Default: 1,
        AllowedLocations: 2
    };
Panopto.Data.registerPanoptoEnum("NetworkRuleColumns");

//# sourceMappingURL=file://seasyn/tfsbuilds/panopto_core_hohno-7a0-revert-saml_x64/20191031.7/_PublishedWebsites/WebUI/Scripts/Panopto/Data.js.map
